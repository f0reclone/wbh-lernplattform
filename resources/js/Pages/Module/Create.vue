...
import {BookOpenIcon, PencilIcon} from "@heroicons/vue/24/solid/index.js";
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-black text-black-200 leading-tight">Modul hinzufügen</h2>
            </div>
        </template>
        <div class="py-12">
