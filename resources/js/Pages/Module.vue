    ...
    <span class="text-2xl font-extrabold mx-2">Modulfilter</span>
        ...
        <div class="left mx-2 lg:px-3 space-y-1">
              ...
              <div class="flex items-center ">
                <input type="checkbox" class="checkbox checkbox-primary" id="semester1" name="semester1">
        ...
        <br>
        <InputLabel><span class="text-lg ml-2 font-extrabold space-y-5">Sortieren nach</span></InputLabel>
        <div class="left mx-2 lg:px-3 space-y-0.5">
              <div>
                <input type="radio" class="radio radio-primary" id="sortBySemester" name="sortOption" value="semester">
          ...
          <br>
          <div class="space-y-2">
            <InputLabel><span class="text-sm ml-2 font-extrabold space-y-5">Erledigte Tasks anzeigen</span></InputLabel>
            <div class="left mx-2 lg:px-3 space-y-0.5">
                <div>
              <input type="radio" class="radio radio-primary" id="showCompletedYes" name="showCompleted" value="yes">
              <label for="showCompletedYes">Ja</label>
            </div>
            <div>
              <input type="radio" class="radio radio-primary" id="showCompletedNo" name="showCompleted" value="no">
      ...
      <div class="flex-1">
        ...
        <!-- Content -->
        <div class="p-8 text">Content</div>
      </div>
